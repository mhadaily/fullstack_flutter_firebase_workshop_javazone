...
const whitelist = ['http://localhost:8000', 'https://fluttervikings.com'];
...
export class CloudTask {
  ...
  /**
   * @param {string} projectId The id of GCP project.
   * @param {string} queueName The name of the queue.
   */
  constructor(projectId: string, queueName: string) {
  ...
  async createTaskForRefernce(
    ...
    const url = `https://europe-west3-${this.project}.cloudfunctions.net/${functionName}`;
